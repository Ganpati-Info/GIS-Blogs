  ...
  return (
    <>
      <button
        ...
        className="flex h-11 w-lg! items-center justify-between rounded-lg border bg-background px-4 text-sm text-muted-foreground transition-colors hover:bg-muted sm:h-10 sm:w-auto sm:justify-start sm:gap-3"
      >

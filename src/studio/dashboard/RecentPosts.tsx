...
import {CalendarDays, ExternalLink, FileText, Pencil, Star} from 'lucide-react'
    ...
    >
      ...
      >
        {posts.length === 0 ? (
          ...
          >
            <FileText size={42} color="#9ca3af" />

            <Box marginTop={4}>
              <Heading size={1}>No Posts Found</Heading>
            </Box>

            <Box marginTop={2}>
              <Text muted>Create your first blog post.</Text>
            </Box>
          </Flex>
        ) : (
          <Stack space={1}>
                  ...
                  >
                    ...
                    >
                      ...
                      <Flex align="center" gap={2} wrap="wrap">
                        {/* Document status */}
                        <Badge tone={post.isDraft ? 'caution' : 'positive'}>
